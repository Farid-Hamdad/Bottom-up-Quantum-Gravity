...
À partir de l'état fondamental $|\Psi_{\rm gal}\rangle$ :
...
$$
\rho_{\rm ent}^{\rm micro}(i) \;=\; \sum_{j} I_{ij}
$$

### Test de fermeture (après lissage radial)

$$
\boxed{\;\rho_{\rm ent}^{\rm micro}(R) \;\propto\; \Sigma(R)\;}
$$
...
| Mesure | Valeur |
|--------|-------:|
| Corrélation $\mathrm{corr}(\rho_{\rm ent}^{\rm micro},\Sigma)$ | $0,997608$ |
| RMSE | $0,020802$ |
| $R_{\rm ent}$ | $3,002641$ |
...
$$
\frac{|R_{\rm ent} - R_d|}{R_d} \;=\; 8{,}80 \times 10^{-4}
\;\;(\text{soit } 0{,}088\%)
$$
...
\qquad\text{et}\qquad
\left\langle \frac{J_{\rm eff}^{\rm spec}}{h_0} \right\rangle \;=\; 1{,}15
$$

où $J_{\rm eff}^{\rm spec}$ est le rayon spectral de la matrice de couplage microscopique $J_{ij}$.
...
| $N$ | Dimension de Hilbert | Fermeture forte | Modérée ou forte | Meilleur $R_{\rm ent}$ | Erreur sur $R_d$ |
|:---:|---------------------:|----------------:|-----------------:|--------------------------:|-----------------:|
