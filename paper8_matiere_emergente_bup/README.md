...
| \(T_{00}-\frac12T_{aa}\) | \(\sigma=0.15\) | 0.526 | 0.017 | source fluide effective |
| \(T_{00}-\frac12T_{aa}+\frac12T_{\rm grad}\) | \(\sigma=0.15\) | 0.612 | 0.00413 | contrainte interne utile |
| \(T_{00}-\frac12T_{aa}+\frac12T_{\rm grad}+\|T_{0a}\|\) | \(\sigma=0.15\) | 0.741 | \(1.84\times10^{-4}\) | meilleure source complète |
...
\[
\frac{
\|\mathrm{div}\,f_{\rm total}\|_2
}{
\|\mathrm{div}\,f_{\rm matter}\|_2
}
=
0.380.
\]
...
\[
\boxed{
\text{la matière BuP est mieux décrite comme une source tensorielle candidate non fermée.}
}
\]
