...
**Auteur :** Farid Hamdad  
**Projet :** Programme Gravité Quantique Bottom-Up  
**Année :** 2026  
...
## Graphe d'intrication et Laplacien
...
## Dérivation dimensionnelle de l'exposant effectif

Le cadre BuP suppose que la réponse gravitationnelle effective est contrôlée par deux ingrédients :

1. le nombre de canaux de diffusion effectifs, contrôlé par \(d_s\) ;
2. l'échelle de propagation anomale, contrôlée par \(d_w\).
...
\[
W_{ij} \;\rightarrow\; L_{\rm ent} \;\rightarrow\; P(t),\; \langle r^2(t) \rangle \;\rightarrow\; d_s,\; d_w \;\rightarrow\; \alpha_{\rm eff}.
\]
...
| Figure | Contenu |
|--------|---------|
| `fig2_ds_vs_N.png` | Dimension spectrale \(d_s\) en fonction de la taille du graphe \(N\) |
| `fig3_dw_vs_N.png` | Dimension de marche \(d_w\) en fonction de la taille du graphe \(N\) |
| `fig4_alpha_predictions_vs_N.png` | Exposant effectif \(\alpha_{\rm eff}\) prédit à partir de \(d_s\) et \(d_w\) |
...
Voir le dépôt principal BuP pour la liste complète des papiers :

- Paper 12 — Courbes de rotation à partir du potentiel effectif BuP
- Paper 14 — Classification SPARC LOW/HIGH et le pont modulaire-gravitationnel
- Paper 21 — Point fixe de lentillage fort SLACS et \(\alpha_{\rm eff} \approx 1\)

---

*Fait partie du programme Gravité Quantique Bottom-Up*  
*Dépôt : [https://github.com/Farid-Hamdad/Bottom-up-Quantum-Gravity](https://github.com/Farid-Hamdad/Bottom-up-Quantum-Gravity)*
